...
class SportsHeroCard(BaseCard):
    ...
    eyebrow_text = StringProperty("LA TIBURONA SPORTS OS")
...
class FieldCard(BaseCard):
    ...
    occupancy_text = StringProperty("Ocupacion live")
    slots_text = StringProperty("Slots listos")
...
class LiveOccupancyCard(BaseCard):
    ...
    subtitle_text = StringProperty("Pulso de canchas, demanda y slots disponibles")
...
class SportsToggle(ButtonBehavior, CardBox):
    ...
    inactive_text = StringProperty("OFF")
